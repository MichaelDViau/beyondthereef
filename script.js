const translations = {
  en: {
    ...
    home: {
      ...
      'home.favorites.copy':
        'Glide through curated escapes with cinematic previews, essential highlights, and a one-tap path to reserve your spot.',
      ...
      'home.favorites.card1.meta': 'Sunrise departures • Private marine biologist',
      'home.favorites.card1.copy':
        'Charter a glassy speedboat at dawn, suit up with a marine biologist, and float alongside gentle giants as the sun ignites the Caribbean.',
      'home.favorites.card1.cta': 'Book now',
      'home.favorites.card2.tag': 'Guest favorite',
      'home.favorites.card2.title': 'The Taco Tour',
      'home.favorites.card2.badge': '-25%',
      'home.favorites.card2.meta': 'Street legends • Mezcal pairings',
      'home.favorites.card2.copy':
        'Slip behind speakeasy counters, toast with small-batch mezcals, and feast on chef-crafted tacos curated by our local food scout.',
      'home.favorites.card2.cta': 'Book now',
      ...
      'home.favorites.card3.meta': 'Starfish haven • Champagne sandbars',
      'home.favorites.card3.copy':
        'Drift over luminous reefs, anchor on powder-blue sandbars, and toast with chilled bubbly as rays glide beneath you.',
      'home.favorites.card3.cta': 'Book now',
      'home.favorites.card4.tag': 'Photo ready',
      'home.favorites.card4.title': 'Tulum Insta Experience',
      'home.favorites.card4.badge': '-18%',
      'home.favorites.card4.meta': 'Creative director • Sunset golden hour',
      'home.favorites.card4.copy':
        'Step into jungle lofts, secret cenotes, and rooftop lounges while a creative director frames each shot with pro lighting.',
      'home.favorites.card4.cta': 'Book now',
  ...
  es: {
    ...
    home: {
      ...
      'home.favorites.copy':
        'Descubre experiencias icónicas con adelantos cinematográficos, detalles esenciales y un acceso directo para reservar tu lugar.',
      ...
      'home.favorites.card1.badge': '-30%',
      'home.favorites.card1.meta': 'Salidas al amanecer • Biólogo marino privado',
      'home.favorites.card1.copy':
        'Zarpa al alba en una lancha pulida, equípate con un biólogo marino y deslízate junto a gigantes dóciles mientras el Caribe se enciende.',
      'home.favorites.card1.cta': 'Reserva ahora',
      'home.favorites.card2.tag': 'Favorito de los huéspedes',
      'home.favorites.card2.title': 'El Taco Tour',
      'home.favorites.card2.badge': '-25%',
      'home.favorites.card2.meta': 'Leyendas callejeras • Maridaje de mezcales',
      'home.favorites.card2.copy':
        'Entra a barras secretas, brinda con mezcales de pequeña producción y disfruta tacos de autor curados por nuestro cazador gastronómico.',
      'home.favorites.card2.cta': 'Reserva ahora',
      'home.favorites.card3.tag': 'Cupos limitados',
      'home.favorites.card3.title': 'Snorkel en El Cielo Cozumel',
      'home.favorites.card3.badge': '-22%',
      'home.favorites.card3.meta': 'Santuario de estrellas • Bancos con champagne',
      'home.favorites.card3.copy':
        'Deslízate sobre arrecifes luminosos, fondea en arenas azul cielo y brinda con burbujas heladas mientras las rayas pasan debajo.',
      'home.favorites.card3.cta': 'Reserva ahora',
      'home.favorites.card4.tag': 'Listo para fotos',
      'home.favorites.card4.title': 'Experiencia Insta en Tulum',
      'home.favorites.card4.badge': '-18%',
      'home.favorites.card4.meta': 'Director creativo • Golden hour asegurada',
      'home.favorites.card4.copy':
        'Recorre lofts selváticos, cenotes secretos y terrazas al atardecer mientras un director creativo ilumina cada toma.',
      'home.favorites.card4.cta': 'Reserva ahora',
