...
(function (win, doc) {
  ...
  var T = {
    ...
    fr: {
      ...
      'tp.tulumund.about': 'Vivez la Riviera Maya à un rythme plus personnel: ruines de Tulum tôt le matin, snorkeling avec tortues marines, puis choix entre plusieurs cénotes ou une expérience souterraine. Une journée privée, fluide et plus authentique.',
      ...
      'tp.cenotes.about': 'Allez au-delà de la visite classique: choisissez jusqu\'à quatre cénotes différents ou une rivière souterraine authentique, avec option rappel pour plus d\'aventure. Une expérience privée, naturelle et sans précipitation.',
      ...
      'tp.tulumexp.about': 'Découvrez Tulum sans la foule avec une arrivée matinale, un guide bilingue certifié et du temps pour explorer calmement. Photos professionnelles et boissons fraîches incluses, avec option de temps libre en ville ou à la plage.',
      ...
      'tp.tulumcoba.about': 'Vivez une vraie expérience maya qui va au-delà des itinéraires classiques: ruines de Tulum face à la mer, Cobá au cœur de la jungle, baignade en cénote et buffet régional, dans un rythme fluide et sans arrêts inutiles.',
      ...
      'tp.chichen.about': 'Vivez Chichén Itzá comme il se doit, avec un départ matinal pour éviter la foule. Explorez le site à votre rythme avec un guide certifié, puis profitez d\'un cénote avec tyrolienne et d\'un buffet local dans une expérience privée, fluide et bien planifiée.',
      ...
      'tp.holbox.about': 'Découvrez Holbox de façon plus exclusive: bateau rapide privé, arrêts sur des îles paisibles, exploration en voiturette de golf et détente dans un beach club. Une journée fluide, confortable et sans foule.',
      ...
      'tp.fishing.about': 'Vivez la pêche en Riviera Maya comme il faut: bateau privé, capitaines locaux expérimentés, action en haute mer selon la saison et ceviche frais préparé à bord. Une sortie personnalisée, simple et mémorable.',
      ...
      'tp.dolphin.about': 'Explorez la réserve de Sian Ka\'an de façon plus naturelle et authentique. Observez dauphins, tortues et oiseaux dans leur habitat, puis terminez avec du snorkeling sur le récif. Une journée privée, bien rythmée et sans foule.',
      ...
      'tp.tacos.about': 'Découvrez un autre côté de la Riviera Maya en fin de journée: baignade dans un grand cénote ouvert, tacos authentiques dans des adresses locales, puis balade à Playa del Carmen. Une expérience privée, détendue et sans précipitation.',
    ...
    es: {
      ...
      'tp.tulumund.about': 'Vive la Riviera Maya de forma más personal: ruinas de Tulum temprano, snorkel con tortugas marinas y elección entre varios cenotes o experiencia subterránea. Un día privado, fluido y más auténtico.',
      ...
      'tp.cenotes.about': 'Ve más allá de la visita típica: elige hasta cuatro cenotes diferentes o un río subterráneo auténtico, con opción de rapel para más aventura. Una experiencia privada, natural y sin prisas.',
      ...
      'tp.tulumexp.about': 'Conoce Tulum sin multitudes con llegada temprana, guía bilingüe certificado y tiempo para explorar con calma. Incluye fotos profesionales y bebidas frías, con opción de tiempo libre en el centro o la playa.',
      ...
      'tp.tulumcoba.about': 'Descubre una experiencia maya real que va más allá de las rutas típicas: ruinas de Tulum frente al mar, Cobá en plena selva, cenote refrescante y buffet regional en un ritmo cómodo y sin paradas innecesarias.',
      ...
      'tp.chichen.about': 'Vive Chichén Itzá como debe ser: salida temprano para evitar multitudes, recorrido a tu ritmo con guía certificado, cenote con tirolesa y buffet local. Una experiencia privada, fluida y bien planificada.',
      ...
      'tp.holbox.about': 'Disfruta Holbox de forma más exclusiva: lancha rápida privada, paradas en islas tranquilas, recorrido en carrito de golf y relax en beach club. Un día fluido, cómodo y sin multitudes.',
      ...
      'tp.fishing.about': 'Vive la pesca en Riviera Maya como debe ser: barco privado, capitanes locales expertos, acción en alta mar según temporada y ceviche fresco preparado a bordo. Una salida personalizada, simple y memorable.',
      ...
      'tp.dolphin.about': 'Explora Sian Ka\'an de forma más natural y auténtica. Observa delfines, tortugas y aves en su hábitat, y termina con snorkel en arrecife. Un día privado, bien organizado y sin multitudes.',
      ...
      'tp.tacos.about': 'Descubre otro lado de la Riviera Maya al atardecer: nado en un gran cenote abierto, tacos auténticos en zonas locales y caminata por Playa del Carmen. Una experiencia privada, relajada y sin prisas.',
