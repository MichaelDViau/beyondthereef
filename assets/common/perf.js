  ...
  function setupGlobalPromo() {
    ...
    if (!doc.getElementById('promoFloatStyles')) {
      ...
      style.textContent = '' +
        ...
        '.promo-main{opacity:1;transition:opacity .2s ease .25s}' +
        '.promo-close{position:absolute;top:8px;right:8px;width:22px;height:22px;border:0;border-radius:50%;background:rgba(255,255,255,.25);color:#fff;font-size:14px;font-weight:700;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:1;transition:opacity .2s ease .25s}' +
        ...
        '.promo-float.is-collapsed .promo-main{opacity:0;pointer-events:none;transition:opacity .12s ease 0s}' +
        '.promo-float.is-collapsed .promo-close{opacity:0;pointer-events:none;transition:opacity .12s ease 0s}' +
