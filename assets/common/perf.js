  ...
  */
  ...
  function setupGlobalPromo() {
    ...
    if (!doc.getElementById('promoFloatStyles')) {
      ...
      style.textContent = '' +
        '.promo-float{position:fixed;left:20px;bottom:16px;z-index:400;width:min(300px,calc(100vw - 40px));background:rgba(255,140,0,1);border:1px solid rgba(255,255,255,.35);border-radius:14px;box-shadow:0 4px 12px rgba(139,69,0,.25);padding:14px 38px 14px 14px;overflow:hidden;text-decoration:none;transition:width .22s ease,height .22s ease,padding .22s ease,border-radius .22s ease}' +
        ...
        '.promo-float.is-collapsed{width:52px;height:52px;padding:0;border-radius:50%;box-shadow:0 4px 12px rgba(139,69,0,.25);cursor:pointer}' +
        ...
        '@media(max-width:767px){.promo-float{left:10px;bottom:16px;width:min(270px,calc(100vw - 20px));padding:12px 34px 12px 12px}.promo-text{font-size:12px}.promo-link{font-size:11px;padding:7px 10px}.promo-float.is-collapsed{width:52px;height:52px}}';
